            ...
            <Row className="px-0 mx-0 w-100">
                ...
                <Col className="mt-4">
                            ...
                            track_application ?
                                ...
                                <Container className="mb-2">
                                    ...
                                    <Row className="px-0 mb-4 mx-0 d-flex align-items-center">
                                        ...
                                        <Col className="px-0" id="colBar">
                                            <ProgressBar className="px-0" id="trackBar" variant="success" now={(stages.find((p) => p.stage === track_application.table[0].Stage).percent)} />
                                        </Col>
                                    </Row>
                                ...
                                :<>
                                    ...
                                    <div class="d-grid gap-2 mt-5">
                                        <button style={{borderRadius:"0.5rem"}} className="btn btn-success py-3 mt-5" id="submitbtn" onClick={()=> resetHandler()}>
                                            <b className="trackButtonText">TRACK NEW APPLICATION</b>
                                        </button>
                                    </div>
                                </>
                    ...
                    <Link to={`/`} className="text-success mx-auto px-5">
                            <h4 className="text-center fs-5" id="trackBackBtn">Back to Homepage</h4>
                    </Link>
                    <Row>
                        <br/>
                        <small className="text-secondary position-absolute text-center" id="trackFooter">Energy Sense Rebate Program <br/>
