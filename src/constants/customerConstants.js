...
export const CUSTOMER_GENERATE_CONTROLNO_REQUEST = 'CUSTOMER_GENERATE_CONTROLNO_REQUEST'
export const CUSTOMER_GENERATE_CONTROLNO_SUCCESS = 'CUSTOMER_GENERATE_CONTROLNO_SUCCESS'
export const CUSTOMER_GENERATE_CONTROLNO_FAIL = 'CUSTOMER_GENERATE_CONTROLNO_FAIL'
...
export const CUSTOMER_EQUIP_MANUFACTURER_REQUEST = 'CUSTOMER_EQUIP_MANUFACTURER_REQUEST'
export const CUSTOMER_EQUIP_MANUFACTURER_SUCCESS = 'CUSTOMER_EQUIP_MANUFACTURER_SUCCESS'
export const CUSTOMER_EQUIP_MANUFACTURER_FAIL = 'CUSTOMER_EQUIP_MANUFACTURER_FAIL'
export const CUSTOMER_EQUIP_MANUFACTURER_RESET = 'CUSTOMER_EQUIP_MANUFACTURER_RESET'
...
export const CUSTOMER_EQUIPMENT_DETAIL_REQUEST = 'CUSTOMER_EQUIPMENT_DETAIL_REQUEST'
export const CUSTOMER_EQUIPMENT_DETAIL_SUCCESS = 'CUSTOMER_EQUIPMENT_DETAIL_SUCCESS'
export const CUSTOMER_EQUIPMENT_DETAIL_FAIL = 'CUSTOMER_EQUIPMENT_DETAIL_FAIL'
export const CUSTOMER_EQUIPMENT_DETAIL_RESET = 'CUSTOMER_EQUIPMENT_DETAIL_RESET'
