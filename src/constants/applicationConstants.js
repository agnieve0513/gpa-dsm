...
export const APPLICATION_DETAIL_PRINT_REQUEST = "APPLICATION_DETAIL_PRINT_REQUEST";
export const APPLICATION_DETAIL_PRINT_SUCCESS = "APPLICATION_DETAIL_PRINT_SUCCESS";
