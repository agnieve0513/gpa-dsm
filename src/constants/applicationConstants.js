...
export const BATCH_APPLICATION_UPDATE_REQUEST = 'BATCH_APPLICATION_UPDATE_REQUEST'
export const BATCH_APPLICATION_UPDATE_SUCCESS = 'BATCH_APPLICATION_UPDATE_SUCCESS'
