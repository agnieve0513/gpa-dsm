...
export const customerEquipManufacturersReducer = (state ={manufacturers:[]}, action) => {
    switch(action.type){
...
export const customerVerifyReducer = (state ={customer_verification:[]}, action) => {
    switch(action.type){
...
export const customerEquipmentDetailReducer = (state ={equipment_detail:[]}, action) => {
    switch(action.type){
...
export const customerDetailReducer = (state ={customer_detail:[]}, action) => {
    switch(action.type){
...
export const customerGenerateControlNoReducer = (state = {customerNo:""}, action) => {
    switch(action.type)
    {
