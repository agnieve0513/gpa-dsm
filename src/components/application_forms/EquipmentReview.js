...
export default class EquipmentReview extends Component {
    ...
    render() {
        ...
        const city_value = city_zipcode.find((p) => p._id === this.props.values.city_village)
        return (
            <div className="container mt-4">
                <h2 className="text-center text-info mb-5">EQUIPMENT REVIEW</h2>
                            ...
                            <Tab eventKey="application_information" title="Applicant Information">
                                <Container className="ml-2 mr-2">
                                    ...
                                    <ListGroup>
                                        ...
                                        <p>City <b>{ city_value.village}</b> </p>
                                        <p>ZIP <b>{city_value.zip_code}</b> </p>
